# Korean Jaso Analyzer for Elasticsearch 7.13.1
...
###### 자동완성용 한글 자소분석기입니다. elasticsearch 7.13.1 에서 테스트 되었습니다

###### *설치*
```
bin/elasticsearch-plugin install https://github.com/mynamewys/elasticsearch-jaso-analyzer/releases/download/v7.13.1/jaso-analyzer-plugin-7.13.1-plugin.zip
```
